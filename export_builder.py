...
from config import COLORS, SAFEGUARD_THRESHOLD, CREDIT_START_FY
...
def build_safeguard_charts(projection_df, fsei_rom, fsei_elec, grid_connected_fy):
    ...
    fig.update_yaxes(title_text='Scope 1 Emissions (tCO₂-e)', secondary_y=False)
    fig.update_yaxes(title_text='Emission Intensity (tCO₂-e/t)', secondary_y=True)
    ...
    if 'SMC_Cumulative' in projection_df.columns and 'SMC_Value_Cumulative' in projection_df.columns:
        ...
        fig2.update_yaxes(title_text='Cumulative Credits (tCO₂-e)', secondary_y=False)
    ...
    if 'SMC_Annual' in projection_df.columns:
        ...
        fig3.update_layout(
            ...
            xaxis_title='Financial Year',
            yaxis_title='Annual Credits (tCO₂-e)',
            height=600,
            template='plotly_white',
            showlegend=False
        )
