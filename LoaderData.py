...
PRINCIPLES:
- Load OperationsMetricsActual.csv and OperationsMetricsBudget.csv
...
def load_all_data(actual_path=None,
    ...
    RowType via LookupIdentifiers, concatenates, aggregates and calculates emissions.

    Args:
        actual_path: Path to OperationsMetricsActual.csv
        budget_path: Path to OperationsMetricsBudget.csv
