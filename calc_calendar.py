...
def date_to_fy(date):
    ...
    Examples:
        date_to_fy(datetime(2023, 6, 30))  â†’ 2023  # Before July
        date_to_fy(datetime(2023, 7, 1))   â†’ 2024  # July onwards
        date_to_fy(datetime(2024, 6, 30))  â†’ 2024  # Last day of FY2024
    """
    if pd.isna(date):
        return None
...
def fy_to_date_range(fy):
    ...
    Examples:
        fy_to_date_range(2024) â†’ (datetime(2023, 7, 1), datetime(2024, 6, 30))
        fy_to_date_range(2028) â†’ (datetime(2027, 7, 1), datetime(2028, 6, 30))
    """
...
def date_to_cy(date):
    ...
    Examples:
        date_to_cy(datetime(2024, 1, 1))   â†’ 2024
        date_to_cy(datetime(2024, 12, 31)) â†’ 2024
    """
    if pd.isna(date):
        return None
...
def cy_to_date_range(cy):
    ...
    Examples:
        cy_to_date_range(2024) â†’ (datetime(2024, 1, 1), datetime(2024, 12, 31))
    """
...
def add_years(date, years):
    ...
    Examples:
        add_years(datetime(2024, 7, 1), 10) â†’ datetime(2034, 7, 1)
        add_years(datetime(2024, 2, 29), 1) â†’ datetime(2025, 2, 28)  # Leap year handling
    """
...
def get_fy_label(date):
    ...
    Examples:
        get_fy_label(datetime(2023, 7, 1)) â†’ "FY2024"
    """
...
def get_cy_label(date):
    ...
    Examples:
        get_cy_label(datetime(2024, 3, 15)) â†’ "CY2024"
    """
